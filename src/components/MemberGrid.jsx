  ...
  if (!members.length) {
    return (
      <div className="text-center py-12 px-4">
        ...
        <p className="text-text-secondary text-sm font-medium">No family members yet</p>
        <p className="text-text-muted text-xs mt-1">Add your first family member to get started.</p>
      </div>
    )
  }
