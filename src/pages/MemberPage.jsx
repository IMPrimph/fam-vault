...
export default function MemberPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-5xl mx-auto">
      ...
      {/* Profile header */}
      <div className="bg-surface-card rounded-2xl border border-stone-200/60 overflow-hidden mb-6">
        <div className={`h-20 bg-gradient-to-r ${gradient} opacity-80`} />
        <div className="px-5 pb-5 -mt-8">
          <div className="flex items-end justify-between">
            <div className="flex items-end gap-4">
              <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-xl font-bold shadow-lg border-4 border-surface-card`}>
                {initials}
              </div>
              <div className="pb-1">
                <h1 className="text-xl font-bold text-text-primary">{targetMember?.name}</h1>
